...
<p>
  <img src="https://skillicons.dev/icons?i=html,css,javascript,typescript,java,spring,tailwindcss,react,nextjs,git,supabase,figma,appwrite,vuejs,vite,cs,c,net,py,php,svelte,laravel,firebase,nodejs,mysql,sqlite,postgres,mongodb,docker,kubernetes,ps,azure,postman" height="100"/>
</p>
